...
export const translations = {
  ...
  en: {
    ...
    dropInPerfect: "Perfect for visitors",
    dropInFeature: "1 CrossFit class / 1 Open Gym entry",
    dropInWeek: "Drop In 1 Week",
    dropInWeekDesc: "Try a full week",
    dropInWeekFeature1: "Unlimited access 7 days",
    dropInWeekFeature2: "All classes included",
    eightSessions: "8 Sessions",
    eightSessionsDesc: "2 workouts per week",
    eightSessionsFeature1: "8 sessions per month",
    eightSessionsFeature2: "Schedule flexibility",
    twelveSessions: "12 Sessions",
    twelveSessionsDesc: "3 workouts per week",
    twelveSessionsFeature1: "12 sessions per month",
    twelveSessionsFeature2: "Schedule flexibility",
    unlimited: "Unlimited",
    unlimitedDesc: "Unlimited access with no restrictions",
    unlimitedFeature1: "Unlimited sessions",
    unlimitedFeature2: "All classes included",
    unlimitedFeature3: "Open Gym included",
    unlimitedFeature4: "Priority booking",
