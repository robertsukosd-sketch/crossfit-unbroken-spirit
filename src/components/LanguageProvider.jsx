...
export const translations = {
  ro: {
    ...
    aboutDesc: "Indiferent în ce punct al vieții ești, vei întâlni la sală oameni care-ți vor succesul. Clasele au participanți în toate stadiile de formă fizică, iar antrenorul adaptează antrenamentul PENTRU TINE. Asta e diferența: nu te adaptezi tu la sală, ci sala se adaptează la tine. În plus, față de o sală comercială, în care ești nevoit să te descurci de unul singur, aici, ai parte de tot sprijinul unui antrenor și al unei comunități puternice care nu judecă.",
...
* **Scaled (Adaptat / Modificat):** *Acesta este cel mai important cuvânt pentru tine!* Orice mișcare și orice greutate din CrossFit pot fi modificate de antrenor pentru a se potrivi nivelului tău fizic actual, păstrând în același timp beneficiile antrenamentului original.`,
  ...
  en: {
    ...
    aboutDesc: "New here or back from competitions? Same class, adapted programming. That's the point: you're not fighting to keep up. You're fighting against yourself. Plus, unlike a commercial gym where you're on your own, here you get the full support of a coach and a strong community that doesn't judge.",
