...
export const translations = {
  ro: {
    ...
    articlesSubtitle: "Resurse, ghiduri și perspective din lumea CrossFit — scrise de antrenori, pentru comunitate.",
    readMore: "Citește mai mult",
    viewAllArticles: "Vezi toate articolele",
    articlesEmpty: "Nu există articole publicate încă. Revino în curând.",
    ...
    heroSubtitle: "Antrenamente ghidate, energie contagioasă și o mentalitate de învingător. Indiferent de condiția ta fizică de astăzi, aici vii să-ți redefinești propriile limite.",
    startNow: "Începe Acum",
    discoverThePrograms: "Descoperă Programele",
    moreThangym: "Mai mult decât un gym",
    aboutDesc: "Cea mai bună oră din ziua ta începe aici.\nTe-ai săturat de rutina plictisitoare de la sală? La CrossFit Unbroken Spirit — cea mai nouă sală CrossFit și fitness din București — credem că fitnessul ar trebui să fie momentul tău preferat al zilei, nu o corvoadă. Combinăm antrenamentele de grup profesionale, o comunitate prietenoasă și exerciții funcționale adaptate nivelului tău, pentru a te ajuta să te miști mai bine, să fii mai puternic și să trăiești mai sănătos. Sala este dotată cu echipamente Rogue, rower, assault bike și ski erg. Fie că ești un sportiv experimentat, fie că faci mișcare rar sau n-ai mai făcut mișcare deloc de mult timp, drumul tău către o versiune mai bună începe cu un singur pas. Fără orgolii, fără intimidare, doar rezultate.",
    ...
    scheduleSubtitleLine2: "(Înscrierile se fac în aplicația ThunderWOD, după plata unui abonament.)",
    coaches: "Antrenori",
    monday: "Luni",
    tuesday: "Marți",
    wednesday: "Miercuri",
    ...
    sending: "Se trimite...",
    thank: "Mulțumim pentru mesaj.",
    thankDesc: "Te vom contacta în cel mult 24 de ore cu un răspuns.",
    thankDescMobile: "Te vom contacta în 24 de ore cu un răspuns.",
    ...
    bookFreeClass: "Rezervă o Clasă Gratuită",
    ...
    startHereTitle: "N-ai Mai Făcut CrossFit? Începe de Aici",
    startHereSubtitle: "Tuturor ne-au fost neclari termenii la început.\nToți am fost în locul tău la un moment dat.",
...
* **Scaled (Adaptat / Modificat):** *Acesta este cel mai important cuvânt pentru tine!* Orice mișcare și orice greutate din CrossFit pot fi modificate de antrenor pentru a se potrivi nivelului tău fizic actual, păstrând în același timp beneficiile antrenamentului original.`,
  ...
  en: {
    ...
    articlesSubtitle: "Resources, guides and perspectives from the world of CrossFit — written by coaches, for the community.",
    readMore: "Read more",
    ...
    heroSubtitle: "Guided workouts, contagious energy and a winner's mindset. No matter where you start, this is where you come to redefine your own limits.",
    startNow: "Start Now",
    ...
    scheduleSubtitleLine2: "(Registrations are done in the ThunderWOD app, after purchasing a membership.)",
    coaches: "Coaches",
    monday: "Monday",
    tuesday: "Tuesday",
    wednesday: "Wednesday",
    ...
    thankDescMobile: "We'll get back to you within 24 hours.",
    follow: "Follow Us",
    ...
    startHereTitle: "Never Done CrossFit? Start Here",
