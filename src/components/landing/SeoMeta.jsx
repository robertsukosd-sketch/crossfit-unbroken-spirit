...
const FAQ_SCHEMA_RO = {
  ...
  "mainEntity": [
    ...
    { "@type": "Question", "name": "Ce înseamnă să fii în formă?", "acceptedAnswer": { "@type": "Answer", "text": "A fi în formă înseamnă să te descurci bine la orice sarcină fizică, nu doar la una anume. Greg Glassman a definit fitness-ul în 2002 prin trei standarde: competența în zece calități fizice, capacitatea de a duce la capăt o sarcină aleasă la întâmplare și pregătirea în toate cele trei sisteme energetice. Nu contează doar la ce ești bun, ci la câte nu ești slab." } },
    { "@type": "Question", "name": "Care sunt cele 10 calități fizice?", "acceptedAnswer": { "@type": "Answer", "text": "Rezistența cardio-respiratorie, anduranța, forța, flexibilitatea, puterea, viteza, coordonarea, agilitatea, echilibrul și precizia. Ești în formă exact în măsura în care ești competent la fiecare dintre ele, nu excelent la una singură." } },
    { "@type": "Question", "name": "Care e diferența dintre forță și putere?", "acceptedAnswer": { "@type": "Answer", "text": "Forța e cât de tare poți împinge sau trage. Puterea e cât de repede reușești — forță maximă aplicată în timp minim. Doi oameni pot ridica aceeași greutate, dar cel care o ridică mai repede are mai multă putere. Forța se construiește prin antrenament; puterea cere și antrenament, și practică." } },
    { "@type": "Question", "name": "Ce sunt sistemele energetice în sport?", "acceptedAnswer": { "@type": "Answer", "text": "Sunt cele trei căi prin care corpul produce energie: fosfagenul (eforturi sub 10 secunde, anaerob), sistemul glicolitic (până la câteva minute, anaerob) și sistemul oxidativ (eforturi lungi, aerob). Fitness-ul complet cere antrenament în toate trei — nu doar cardio de durată." } },
    { "@type": "Question", "name": "De ce nu e bine să te specializezi în antrenament?", "acceptedAnswer": { "@type": "Answer", "text": "Pentru că specializarea îți dă un vârf ascuțit și goluri mari. Viața, munca și majoritatea sporturilor cer eforturi pe care nu le poți alege dinainte. Cine e pregătit larg se descurcă onorabil la orice; specialistul e neajutorat în afara domeniului lui. De aceea în CrossFit specialitatea e să nu te specializezi." } }
  ]
};
...
const FAQ_SCHEMA_EN = {
  ...
  "mainEntity": [
    ...
    { "@type": "Question", "name": "What does it mean to be in shape?", "acceptedAnswer": { "@type": "Answer", "text": "Being in shape means handling any physical task well, not just one kind. Greg Glassman defined fitness in 2002 through three standards: competency in ten physical qualities, the ability to complete a randomly chosen task, and training across all three energy systems. It's not about what you're good at — it's about how many things you're not weak at." } },
    { "@type": "Question", "name": "What are the 10 physical qualities?", "acceptedAnswer": { "@type": "Answer", "text": "Cardio-respiratory endurance, stamina, strength, flexibility, power, speed, coordination, agility, balance, and accuracy. You're in shape exactly to the extent you're competent at each one — not excellent at a single one." } },
    { "@type": "Question", "name": "What's the difference between strength and power?", "acceptedAnswer": { "@type": "Answer", "text": "Strength is how hard you can push or pull. Power is how fast you can do it — maximum force applied in minimum time. Two people can lift the same weight, but the one who lifts it faster has more power. Strength is built through training; power needs both training and practice." } },
    { "@type": "Question", "name": "What are the energy systems in sport?", "acceptedAnswer": { "@type": "Answer", "text": "They're the three pathways the body uses to produce energy: the phosphagen system (efforts under 10 seconds, anaerobic), the glycolytic system (up to a few minutes, anaerobic), and the oxidative system (longer efforts, aerobic). Complete fitness requires training all three — not just long-duration cardio." } },
    { "@type": "Question", "name": "Why is it bad to specialize in training?", "acceptedAnswer": { "@type": "Answer", "text": "Because specialization gives you a sharp peak and big gaps. Life, work, and most sports demand efforts you can't choose in advance. Someone trained broadly handles anything respectably; the specialist is helpless outside their domain. That's why in CrossFit the specialty is not specializing." } }
  ]
};
...
const PARTNERS_FAQ_EN = [
  ...
  { "@type": "Question", "name": "Can an employee with 7Card or WellHub come to CrossFit Unbroken Spirit?", "acceptedAnswer": { "@type": "Answer", "text": "Yes. CrossFit Unbroken Spirit is a 7Card by WellHub partner. Users can access the gym with no extra fee. Class booking is done directly through the ThunderWOD app." } },
