...
const FALLBACK_DATA = {
  ...
  reviews: [
    { author_name: "Alexandra Radutu", profile_photo_url: "https://lh3.googleusercontent.com/a-/ALV-UjXlsRTnrFMm2ILj77mg9nRGadklBFqgDI9vIGCaLrtDi1X_y3w4Mg=s128-c0x00000000-cc-rp-mo-ba3", rating: 5, relative_time_description: "acum o săptămână", text: "CrossFit Unbroken Spirit 👉🏻 hottest CF affiliate box in town🔥🏋️\nÎn ceea ce privește echiparea, totul este nou-nouț. Sala este dotată complet Rogue, ceea ce pentru pasionați chiar face diferența.\nAntrenamentele au o structură clară, există o progresie și simți că fiecare sesiune te duce mai aproape de un obiectiv. Antrenorii sunt implicați, atenți și știu exact cum să adapteze exercițiile în funcție de nivel.\n\nBonus mare: loc de parcare inclus și proximitatea de metrou Mihai Bravu.\n\nPer total, una dintre cele mai bune experiențe de până acum într-o sală de CrossFit. Recomand cu drag!" },
    { author_name: "Ana Maria Onuta", profile_photo_url: "https://lh3.googleusercontent.com/a-/ALV-UjWvutHx1aA4bOohwJ2PUSyVaeCtCypYaafHWYJtRSouW_4w4DKBsg=s128-c0x00000000-cc-rp-mo", rating: 5, relative_time_description: "acum o săptămână", text: "Super frumoasă sală și dotată!! Foarte curat și Dumitru pregătește niste antrenamente super bune. Recomand această sala!!" },
