...
const getCategories = (language) => [
    ...
    plans: [
      {
        ...
        features: language === 'ro'
          ? ['Grup restrâns de maxim 3 persoane', 'Program individualizat', 'Nutriție de bază', 'Suport WhatsApp', 'Monitorizare progres', 'Loc de parcare inclus']
          : ['Small group of up to 3 people', 'Individualized program', 'Basic nutrition', 'WhatsApp support', 'Progress monitoring', 'Free parking spot'],
        popular: false,
        featured: false,
      },
      {
        ...
        features: language === 'ro'
          ? ['Grup restrâns de maxim 3 persoane', 'Program individualizat', 'Tehnici avansate', 'Feedback constant', 'Loc de parcare inclus']
          : ['Small group of up to 3 people', 'Individualized program', 'Advanced techniques', 'Constant feedback', 'Free parking spot'],
        popular: true,
        featured: true,
      },
      {
  ...
  },
  {
    ...
    icon: Handshake,
    description: language === 'ro'
      ? 'Ai abonament SanoPass, 7Card by WellHub sau buget Edenred Benefit?\nPoți veni la noi cu o coplată redusă, fără să cumperi un abonament separat la prețul întreg.'
      : 'Have a SanoPass, 7Card by WellHub or Edenred Benefit budget?\nYou can train with us for a small co-payment — no need to buy a full separate membership.',
    plans: [],
    isPartnersTab: true,
  },
];
  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        plan.featured
          ? 'bg-gradient-to-br from-blue-600 to-sky-500 shadow-2xl shadow-blue-500/25 ring-2 ring-amber-400/40'
    ...
    >
      ...
      {plan.popular && (
        <div className={cn(
          'absolute -top-3 left-1/2 -translate-x-1/2 px-4 py-1 text-xs font-bold uppercase tracking-wider rounded-full whitespace-nowrap z-20',
  ...
  return (
    <section id="pricing" className="py-24 bg-zinc-950 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
        ...
        {/* Category Tabs */}
         <div className="flex flex-wrap justify-center gap-2 sm:gap-3 mb-10 max-w-none mx-auto">
           {categories.map((cat) => {
             const Icon = cat.icon;
             ...
             return (
               <button
                 ...
                 className={cn(
                   'flex items-center justify-center gap-2 px-3 sm:px-4 py-2 sm:py-2.5 rounded-full text-xs sm:text-sm font-bold transition-all duration-200 border',
                   isActive
