...
const getCategories = (language) => [
  {
    id: 'core',
    label: language === 'ro' ? 'Unbroken Core' : 'Unbroken Core',
    ...
    plans: [
      {
        ...
        features: language === 'ro'
          ? ['8 ședințe pe lună', 'Flexibilitate program', 'Acces la toate orele', 'Loc de parcare inclus']
          : ['8 sessions per month', 'Schedule flexibility', 'Access to all class times', 'Free parking spot'],
        popular: false,
        featured: false,
      },
      {
        ...
        features: language === 'ro'
          ? ['12 ședințe pe lună', 'Flexibilitate program', 'Acces la toate orele', 'Loc de parcare inclus']
          : ['12 sessions per month', 'Schedule flexibility', 'Access to all class times', 'Free parking spot'],
        popular: true,
        featured: false,
      },
      {
  ...
  },
  {
    ...
    plans: [
      ...
      },
      {
        ...
        features: language === 'ro'
          ? ['Toate beneficiile abonamentului Nelimitat', 'Tarif special pentru tineri']
          : ['All Unlimited Membership benefits', 'Special rate for young athletes'],
        popular: false,
        featured: false,
      },
      {
  ...
  },
  {
    ...
    icon: Globe,
    description: language === 'ro'
      ? 'În vizită sau curios să încerci? Ești binevenit exact așa cum ești. Experimentează spiritul Unbroken fără angajament.'
    ...
    plans: [
      {
        ...
        features: language === 'ro'
          ? ['1 ședință CrossFit sau Open Gym', 'Acces complet la facilități', 'Perfect pentru vizitatori']
          : ['1 CrossFit or Open Gym session', 'Full access to facilities', 'Perfect for visitors'],
        popular: false,
        featured: false,
      },
      {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
        ...
        >
          ...
          <p className="text-gray-400 text-base sm:text-lg max-w-2xl mx-auto">
            {language === 'ro'
              ? 'Alege calea ta. Fiecare opțiune este o treaptă spre cea mai bună versiune a ta.'
