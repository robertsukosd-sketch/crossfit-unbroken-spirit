...
const getSchedule = (t, language) => ({
  [t("monday")]: [
    ...
    { time: "12:30-20:30", class: "Open Gym", spots: 12, spotsNote: language === 'ro' ? "4 locuri (12:30-13:30 și 17:30-20:30)" : "4 spots (12:30-13:30 and 17:30-20:30)" },
  ...
  [t("saturday")]: [
    { time: "08:00-10:00", class: "Open Gym", spots: 12 },
    ...
    <section id="schedule" className="py-24 bg-black relative">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <motion.div
          ...
          className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 max-w-[1086px] mx-auto"
        >
              ...
              >
                ...
                {item.spots && (
                  <div className="flex flex-col items-start gap-0 mb-2">
                    ...
                    <span className="text-xs opacity-40">{language === 'ro' ? '(cap. max orientativă)' : '(indicative max cap.)'}</span>
                  </div>
                )}
