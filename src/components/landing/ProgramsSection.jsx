      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-black text-white mt-3 mb-6">
            Programele <span className="text-red-500">Noastre</span>
          </h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {programs.map((program, index) => (
            <motion.div
              ...
              className="group relative bg-zinc-900/50 rounded-2xl overflow-hidden border border-zinc-800 hover:border-red-500/50 transition-all duration-500"
            >
              {/* Image */}
        ...
        >
          <Button 
            ...
            className="bg-gradient-to-r from-red-600 to-orange-500 hover:from-red-700 hover:to-orange-600 text-white px-10 py-6 text-lg font-bold rounded-full"
          >
