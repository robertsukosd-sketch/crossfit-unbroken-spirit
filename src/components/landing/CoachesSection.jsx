...
export default function CoachesSection() {
  ...
  const coaches = [
    ...
    },
    {
      ...
      certifications: language === 'ro'
        ? ['Antrenor de 7 ani', 'Atlet competitiv CrossFit de 7 ani', 'Haltere & Gimnastică', 'Competition training']
        : ['7 years as a coach', '7 years competitive CrossFit athlete', 'Weightlifting & Gymnastics', 'Competition training'],
