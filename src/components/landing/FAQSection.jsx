...
const FAQ_CATEGORIES = {
  crossfit: ['what-is', 'vs-gym', 'faq-wod-meaning', 'benefits', 'weight-loss', 'bulk-up', 'isolation', 'nutrition', 'fitness-definition', 'ten-qualities', 'strength-vs-power', 'energy-systems', 'specialization'],
  beginners: ['fitness-required', 'no-weights-before', 'safety', 'old-injury', 'what-to-bring', 'free-trial', 'how-to-start', 'scaling', 'age-start'],
...
export default function FAQSection({ onBookSession }) {
  ...
  const getFAQs = () => {
    if (language === 'ro') {
      return [
        { id: 'what-is', q: 'Ce înseamnă CrossFit?', a: 'CrossFit este un program de forță și condiție fizică bazat pe mișcări funcționale, variate constant, executate la intensitate mare. Scopul nu e să te facă bun la un singur lucru, ci competent la cât mai multe feluri de efort. Urmărește competența în zece calități fizice — rezistență cardio-respiratorie, anduranță, forță, flexibilitate, putere, viteză, coordonare, agilitate, echilibru și precizie — nu excelența într-una singură.', aImage: true },
        { id: 'vs-gym', q: 'Prin ce diferă CrossFitul de o sală comercială?', a: 'La o sală obișnuită plătești pentru acces la aparate și te antrenezi pe cont propriu. La CrossFit Unbroken Spirit, abonamentul presupune participarea la clase de grup ghidate de antrenor. Fiecare antrenament este deja programat și structurat, iar antrenorul te ghidează pe parcursul sesiunii. Asta înseamnă că nu trebuie să te întrebi „ce fac azi?" — noi ne ocupăm de programare și antrenamente, iar comunitatea oferă suport, motivație și energie la fiecare clasă. În plus, în loc de mișcări de izolare la aparate, lucrăm mișcări compuse — genuflexiuni, îndreptări, tracțiuni, împins — care implică mai multe articulații deodată, așa cum cere viața reală.', aHighlightGym: true },
        ...
        { id: 'weight-loss', q: 'Pot slăbi făcând CrossFit?', a: 'Da. Efortul anaerob (scurt și intens) scade grăsimea corporală și, la acest capitol, e mai eficient decât cardio-ul de durată. Rezultatul depinde însă în primul rând de alimentație — prima treaptă a ierarhiei dezvoltării în CrossFit. Antrenamentul fără o dietă consecventă duce rar la schimbări vizibile.' },
        ...
        { id: 'isolation', q: 'De ce nu se fac exerciții de izolare în CrossFit?', a: 'Pentru că nu au echivalent în viața reală, lucrează o singură articulație și declanșează un răspuns hormonal aproape nul. Mișcările funcționale — genuflexiunea, îndreptarea, tracțiunea — implică mai multe articulații deodată, sunt corecte mecanic (deci sigure) și produc un răspuns hormonal puternic. Pentru timpul investit, izolările dau cel mai puțin înapoi.' },
        { id: 'nutrition', q: 'Ce trebuie să mănânc dacă fac CrossFit?', a: 'Carne slabă, pește, ouă, legume (mai ales verzi), nuci și semințe. Carbohidrații se aleg pentru indicele glicemic mic, iar zahărul se reduce la minimum. Proporția orientativă: 40% carbohidrați, 30% proteine, 30% grăsimi. Alimentația e prima treaptă a ierarhiei dezvoltării — fără ea, condiția fizică nu vine.' },
        { id: 'fitness-definition', q: 'Ce înseamnă să fii în formă?', a: 'Înseamnă să te descurci bine la orice sarcină fizică, nu doar la una anume. Greg Glassman a definit fitness-ul în 2002 prin trei standarde: competența în zece calități fizice, capacitatea de a duce la capăt o sarcină aleasă la întâmplare și pregătirea în toate cele trei sisteme energetice. Nu contează doar la ce ești bun, ci la câte nu ești slab.' },
        { id: 'ten-qualities', q: 'Care sunt cele 10 calități fizice?', a: 'Rezistența cardio-respiratorie, anduranța, forța, flexibilitatea, puterea, viteza, coordonarea, agilitatea, echilibrul și precizia. Ești în formă exact în măsura în care ești competent la fiecare dintre ele, nu excelent la una singură.' },
        { id: 'strength-vs-power', q: 'Care e diferența dintre forță și putere?', a: 'Forța e cât de tare poți împinge sau trage. Puterea e cât de repede reușești — forță maximă aplicată în timp minim. Doi oameni pot ridica aceeași greutate, dar cel care o ridică mai repede are mai multă putere. Forța se construiește prin antrenament; puterea cere și antrenament, și practică.' },
        { id: 'energy-systems', q: 'Ce sunt sistemele energetice în sport?', a: 'Sunt cele trei căi prin care corpul produce energie: fosfagenul (eforturi sub 10 secunde, anaerob), sistemul glicolitic (până la câteva minute, anaerob) și sistemul oxidativ (eforturi lungi, aerob). Fitness-ul complet cere antrenament în toate trei — nu doar cardio de durată.' },
        { id: 'specialization', q: 'De ce nu e bine să te specializezi în antrenament?', a: 'Pentru că specializarea îți dă un vârf ascuțit și goluri mari. Viața, munca și majoritatea sporturilor cer eforturi pe care nu le poți alege dinainte. Cine e pregătit larg se descurcă onorabil la orice; specialistul e neajutorat în afara domeniului lui. De aceea în CrossFit specialitatea e să nu te specializezi.' },
        { id: 'fitness-required', q: 'Trebuie să fiu în formă înainte de a începe CrossFit?', a: 'Categoric nu. Acesta e cel mai mare mit! CrossFit este procesul prin care ajungi în formă. Metoda a fost testată atât pe sportivi olimpici, cât și pe persoane sedentare, supraponderale sau vârstnice — se ajustează încărcătura și intensitatea, nu programul. Nu ai nevoie de experiență ca să începi.' },
        ...
        { id: 'scaling', q: 'Ce înseamnă „scalarea" unui antrenament?', a: 'Înseamnă adaptarea greutății, a distanței, a numărului de repetări sau a complexității mișcării la capacitatea fiecăruia. Antrenamentul rămâne același pentru toată lumea; se schimbă doar doza. Nevoile unui om obișnuit și ale unui campion olimpic diferă doar ca ordin de mărime, nu ca esență — se schimbă greutatea, nu exercițiul.' },
        { id: 'age-start', q: 'La ce vârstă pot începe CrossFit?', a: 'Nu există o limită superioară. Corpul răspunde la antrenament și la 70 sau 80 de ani — mai lent, dar răspunde. Un om antrenat la 80 de ani poate fi mai puternic decât un sedentar la 25. După 30 de ani pierzi natural din forță în fiecare an; antrenamentul de forță e singurul care ameliorează panta.' },
    ...
    return [
      { id: 'what-is', q: 'What is CrossFit?', a: 'CrossFit is a strength and conditioning program based on functional movements, constantly varied, performed at high intensity. The goal isn\'t to make you good at one thing, but competent at as many kinds of effort as possible. It pursues competency in ten physical qualities — cardio-respiratory endurance, stamina, strength, flexibility, power, speed, coordination, agility, balance, and accuracy — not excellence in a single one.', aImage: true },
      { id: 'vs-gym', q: 'How is CrossFit different from a regular gym?', a: 'At a regular gym, you pay for equipment access and train on your own. At CrossFit Unbroken Spirit, your membership means participating in group classes led by a coach. Every workout is already programmed and structured, and the coach guides you throughout the session. That means you never have to wonder "what do I do today?" — we handle the programming and workouts, while the community provides support, motivation, and energy at every class. Plus, instead of isolation exercises on machines, we use compound movements — squats, deadlifts, pull-ups, presses — that involve multiple joints at once, just like real life demands.', aHighlightGym: true },
      ...
      { id: 'weight-loss', q: 'Can I lose weight doing CrossFit?', a: 'Yes. Anaerobic effort (short and intense) reduces body fat and, on this front, is more effective than long-duration cardio. The result depends primarily on nutrition, however — the first rung of CrossFit\'s hierarchy of development. Training without a consistent diet rarely produces visible changes.' },
      ...
      { id: 'isolation', q: 'Why no isolation exercises in CrossFit?', a: 'Because they have no real-life equivalent, work a single joint, and trigger an almost negligible hormonal response. Functional movements — the squat, deadlift, pull-up — involve multiple joints at once, are mechanically correct (therefore safe), and produce a powerful hormonal response. For the time invested, isolation exercises give the least back.' },
      { id: 'nutrition', q: 'What should I eat if I do CrossFit?', a: 'Lean meat, fish, eggs, vegetables (especially greens), nuts and seeds. Choose carbohydrates with a low glycemic index and keep sugar to a minimum. The guideline ratio: 40% carbs, 30% protein, 30% fat. Nutrition is the first rung of the development hierarchy — without it, fitness doesn\'t come.' },
      { id: 'fitness-definition', q: 'What does it mean to be in shape?', a: 'It means handling any physical task well, not just one kind. Greg Glassman defined fitness in 2002 through three standards: competency in ten physical qualities, the ability to complete a randomly chosen task, and training across all three energy systems. It\'s not about what you\'re good at — it\'s about how many things you\'re not weak at.' },
      { id: 'ten-qualities', q: 'What are the 10 physical qualities?', a: 'Cardio-respiratory endurance, stamina, strength, flexibility, power, speed, coordination, agility, balance, and accuracy. You\'re in shape exactly to the extent you\'re competent at each one — not excellent at a single one.' },
      { id: 'strength-vs-power', q: 'What\'s the difference between strength and power?', a: 'Strength is how hard you can push or pull. Power is how fast you can do it — maximum force applied in minimum time. Two people can lift the same weight, but the one who lifts it faster has more power. Strength is built through training; power needs both training and practice.' },
      { id: 'energy-systems', q: 'What are the energy systems in sport?', a: 'They\'re the three pathways the body uses to produce energy: the phosphagen system (efforts under 10 seconds, anaerobic), the glycolytic system (up to a few minutes, anaerobic), and the oxidative system (longer efforts, aerobic). Complete fitness requires training all three — not just long-duration cardio.' },
      { id: 'specialization', q: 'Why is it bad to specialize in training?', a: 'Because specialization gives you a sharp peak and big gaps. Life, work, and most sports demand efforts you can\'t choose in advance. Someone trained broadly handles anything respectably; the specialist is helpless outside their domain. That\'s why in CrossFit the specialty is not specializing.' },
      { id: 'fitness-required', q: 'Do I need to be in shape before starting CrossFit?', a: 'Absolutely not. This is the biggest myth! CrossFit is the process of getting in shape. The method has been tested on both Olympic athletes and sedentary, overweight, or elderly people — the load and intensity are adjusted, not the program. You don\'t need experience to start.' },
      ...
      { id: 'safety', q: 'Is CrossFit dangerous? Will I get injured?', a: 'Functional movements are mechanically correct and therefore safe when performed correctly. The risk arises when weight is added before the movement is mastered. That\'s why we follow the philosophy "Mechanics, Consistency, then Intensity" — we insist on moving correctly before moving fast or with heavy weights.' },
      ...
      { id: 'scaling', q: 'What does "scaling" a workout mean?', a: 'It means adapting the weight, distance, number of reps, or complexity of a movement to each person\'s capacity. The workout stays the same for everyone; only the dose changes. The needs of an ordinary person and an Olympic champion differ only by degree, not by kind — the weight changes, not the exercise.' },
      { id: 'age-start', q: 'At what age can I start CrossFit?', a: 'There is no upper limit. The body responds to training at 70 or 80 — more slowly, but it responds. A trained 80-year-old can be stronger than a sedentary 25-year-old. After 30 you naturally lose strength each year; strength training is the only thing that softens the curve.' },
      ...
      <p className="text-gray-300 text-sm sm:text-base leading-relaxed whitespace-pre-line">
        ...
        {faq.aClassDuration && (
          <>
            ...
            {language === 'ro' ? ' și revenirea (stretching). Efortul intens propriu-zis durează de obicei între 10 și 35 de minute — peste 45–60 de minute, intensitatea care produce rezultate nu mai poate fi susținută. Asta nu înseamnă că, dacă vrei să stai mai mult de o oră în sală, nu poți s-o faci. Ești binevenit să stai cât vrei în limita programului.' : ' and cool-down (stretching). The intense portion itself usually lasts between 10 and 35 minutes — beyond 45–60 minutes, the intensity that produces results can no longer be sustained.'}
          </>
        )}
        {faq.aPricing && (
          <>
        ...
        {faq.aFrequency && (
          <>
            ...
            {language === 'ro' ? ' pentru a permite corpului să se recupereze. Ținta ideală e o oră pe zi, șase zile pe săptămână — suficient pentru o condiție fizică de top la categoria ta de vârstă. Pe măsură ce avansează, mulți membri aleg 4-5 zile pentru rezultate optime; rezultate bune apar și la 3-4 antrenamente făcute constant.' : ' to allow your body to recover. The ideal target is one hour a day, six days a week — enough for top fitness for your age group. As you progress, many members choose 4-5 days for optimal results; good results also come from 3-4 consistent workouts.'}
          </>
        )}
        {faq.aDropIn && (
