  ...
  const getFAQs = () => {
    if (language === 'ro') {
      return [
        ...
        },
        {
          id: 'faq-wod-meaning',
          q: 'Ce înseamnă WOD?',
          a: 'În lumea CrossFit, WOD (pronunțat ca un cuvânt, „uod") este cel mai des întâlnit acronim pe care îl vei auzi în sală.\nAcesta provine din limba engleză și înseamnă Workout of the Day (Antrenamentul Zilei).\nDe ce se numește WOD?\nFilosofia CrossFit se bazează pe „mișcări funcționale, variate constant, executate la intensitate ridicată". În loc să faci o „zi de picioare" sau o „zi de cardio", antrenamentul se schimbă în fiecare zi.\n• Universalitate: Toți din sală — de la sportivii de performanță până la începători — fac același WOD într-o zi, adaptat (scalat) în funcție de nivelul individual de fitness.\n• Elementul surpriză: O parte din distracția (și emoția!) de a face CrossFit este să verifici aplicația sălii sau tabla pentru a vedea „WOD-ul" zilei.\n• Monitorizarea progresului: Deoarece este un antrenament specific și măsurabil, îți poți nota rezultatul pentru a-l compara cu performanța ta de peste câteva luni, când același WOD poate va apărea din nou în program.\nCum arată un WOD?\nWOD-ul este, de obicei, partea de intensitate ridicată a clasei. Durează, în medie, între 5 și 25 de minute și poate avea diferite formate, cum ar fi:\n• AMRAP: As Many Rounds As Possible (Cât mai multe runde posibile într-un timp stabilit).\n• EMOM: Every Minute on the Minute (Execuți un număr de repetări la începutul fiecărui minut).\n• For Time: Finalizarea exercițiilor cât mai rapid posibil.\n• Chipper: O listă lungă de exerciții diferite, pe care trebuie să le „mărunțești" până când termini tot volumul de muncă.'
        },
        {
          id: 'fitness-required',
    ...
    return [
      ...
      },
      {
        ...
        a: 'All classes last about 60 minutes. They include a walkthrough, a guided warm-up, a strength or technique session, ',
        aClassDuration: true
      },
      {
        id: 'pricing',
