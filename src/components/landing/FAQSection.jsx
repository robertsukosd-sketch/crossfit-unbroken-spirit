...
const FAQ_CATEGORIES = {
  crossfit: ['what-is', 'vs-gym', 'faq-wod-meaning', 'benefits', 'weight-loss', 'bulk-up', 'isolation', 'nutrition'],
  ...
  const getFAQs = () => {
    if (language === 'ro') {
      return [
        ...
        { id: 'safety', q: 'Este CrossFitul periculos? Există riscuri să mă accidentez?', a: 'Mișcările funcționale sunt corecte mecanic și, prin urmare, sigure atunci când sunt executate corect. Riscul apare când se adaugă greutate înainte ca mișcarea să fie stăpânită. De aceea respectăm filosofia: "Mecanică, Consistență, apoi Intensitate" — insistăm să te miști corect înainte de a te mișca repede sau cu greutăți mari.' },
