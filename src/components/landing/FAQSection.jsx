    ...
    if (language === 'ro') {
      return [
        ...
        },
        {
          id: 'faq-wod-meaning',
          q: 'Ce înseamnă WOD?',
          a: 'În lumea CrossFit, WOD (pronunțat ca o cuvânt, "wad") este acronimul cel mai des întâlnit.\nStă pentru Workout of the Day (Antrenamentul Zilei).\n\nDe ce se numește WOD?\nFilosofia din spatele CrossFit este "mișcări funcționale, constant variate". În loc să ai "Ziua Picioarelor" sau "Ziua Cardio", antrenamentul se schimbă în fiecare zi.\n• Universalitate: Toți din sală—atât atletul antrenat, cât și începătorul—fac același WOD în aceeași zi (adaptat la nivelul lor de fitness individual).\n• Necunoscutul: Partea distractiv (și de neliniște!) este să verifici aplicația sau tablita din sală pentru a vedea care este WOD-ul pentru acea zi.\n• Urmărirea: Deoarece este un antrenament specific "prescris", poți înregistra scorul tău și poți să-l compari cu cum o faci atunci când același WOD reapare luni mai târziu.\n\nCum arată un WOD?\nUn WOD este de obicei porțiunea de înaltă intensitate a clasei. De obicei durează oriunde între 5 și 20 de minute și poate urma diferite formate, cum ar fi:\n• AMRAP: As Many Rounds As Possible (în timp stabilit).\n• EMOM: Every Minute on the Minute.\n• For Time: Completează munca cât mai repede posibil.\n• Chipper: O listă lungă de mișcări pe care le "ciobești" până la sfârșit.'
        },
        {
          id: 'fitness-required',
